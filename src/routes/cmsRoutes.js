...
router.post(
  ...
  verifyToken,
  upload.single("image"),
  cmsController.createContents
);
router.put("/:id", verifyToken, cmsController.updateContents);
router.delete("/:id", verifyToken, cmsController.deleteContents);

// Public route for fetching all content
